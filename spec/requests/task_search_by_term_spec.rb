...
describe 'GET /search' do
  ...
  context '期間を指定しない' do
    ...
    it do
      get search_path(c: { from_date: nil, to_date: nil, is_signed_up_only: '0', completion_state: 'any' })
      tasks = assigns(:tasks)
      expect(tasks).to eq(expected_tasks + unexpected_tasks)
    end
  end
  ...
  context '期間の絞り込みの開始日を指定' do
    ...
    it do
      get search_path(c: { from_date: '2015-12-01', to_date: nil, is_signed_up_only: '0', completion_state: 'any' })
      tasks = assigns(:tasks)
  ...
  context '期間の絞り込みの終了日を指定' do
    ...
    it do
      get search_path(c: { from_date: nil, to_date: '2015-11-30', is_signed_up_only: '0', completion_state: 'any' })
      tasks = assigns(:tasks)
      expect(tasks).to eq(expected_tasks)
    end
  end
  ...
  context '期間の絞り込みの開始日と終了日を指定' do
    ...
    it do
      get search_path(c: { from_date: '2015-12-01', to_date: '2015-12-31', is_signed_up_only: '0', completion_state: 'any' })
      tasks = assigns(:tasks)
      expect(tasks).to eq(expected_tasks)
    end
  end

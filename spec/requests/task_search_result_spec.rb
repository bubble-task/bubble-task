...
describe 'GET /search' do
  ...
  context '検索結果はタスクの作成日時の昇順' do
    ...
    let(:task1) { create_task(author_id: user_a.id, title: '1', tags: %w(tag), completed_at: '2015-12-01 00:00:00') }
    let(:task2) { create_task(author_id: user_a.id, title: '2', tags: %w(tag), completed_at: '2015-12-01 00:00:01') }
    let(:task3) { create_task(author_id: user_a.id, title: '3', tags: %w(tag), completed_at: '2015-12-05') }
